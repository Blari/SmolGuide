package by.plisa.smolguide.adapters;
...
public class AttractionAdapter extends ArrayAdapter<Attraction> {
    ...
    public AttractionAdapter(Context context, int resource) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if( convertView == null ) {
            ...
            convertView = LayoutInflater.from( getContext() ).inflate( R.layout.view_attraction_list_item, parent, false );
